...
{   
    ...
    {
        // активаци€ рабочего меню в зависимости от роли
        switch (role)
        {
            case "ADMIN":
    ...
    {        
        ...
        Saving.SaveSerial.SaveAccountSettings(gl.playerInfo.responseUserData); // стираем сохранЄнные данные в локальном файле       
